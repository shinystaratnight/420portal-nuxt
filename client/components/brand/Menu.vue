    ...
    <div id="menuForm">
        ...
        <div class="page-data">            
            ...
            <div class="menu-panel mt-3" v-show="!$device.isMobile || ($device.isMobile && !show_filter)">
                ...
                <div class="menu-list">
                    <template v-for="category of brand_categories" v-if="categoryMenu(category.id).length">
    ...
    methods: {
        ...
        getMenus(){
            ...
            this.axios.post('/portal/get_all_menus', params)
                .then(response => {
                    this.brand_categories = response.data.data.portal_categories;
                    this.brand_menus = response.data.data.menus;
        ...
        getStrain(event) {
            ...
            this.axios.post(url, data)
                .then(response => {
                    ...
                    let not_listed_below = { id : 0, name : 'Not Listed Below'};
                    this.strains.unshift(not_listed_below);
        ...
        getCategoryResults(item) {
            return this.brand_menus.filter(m => m.category_id == item.id).length;
        },
        searchMenus() {
            this.menus = this.brand_menus;
